...
const Navbar = () => {
    return(
        ...
        <div>
            ...
            <div className="ms-3 font-bold text-white hidden sm:block">Overview</div>
            </div>
            </Link>
            <Link to="/balance">
            <div className="flex hover:bg-special-bg3 px-4 py-3 rounded-md">
            <div className="mx-auto sm:mx-0">B</div>
            <div className="ms-3 text-special-bg2 hidden sm:block">Balances</div>
            </div>
            </Link>
            
            <div className="flex hover:bg-special-bg3 px-4 py-3 rounded-md">
            <div className="mx-auto sm:mx-0">C</div>
            <div className="ms-3 text-special-bg2 hidden sm:block">Transactions</div>
            </div>
        </div>
